...
MODULE_SOURCES = $(shell find stdlib -type f -name "*.rp")
...
rbot:
	@mkdir -p rbot-build
	@$(CC) -Wall -Wextra -c src_rbot/main.c -o rbot-build/main.o
	@$(CC) rbot-build/main.o -o bin/rbot
	@rm -rf rbot-build
	@echo "build ok"
